...
public class WordFrequency {
    ...
    // Method to count word frequencies in a cleaned article
    ...
    public static void main(String[] args) throws Exception {
        // Example usage with a cleaned article (sample data for testing)
        ArrayList<String> cleanedArticle = new ArrayList<>();
